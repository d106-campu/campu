...
VALUES ('hoing97s', '1234', 'hoing97s', 'M', '2000', 'https://avatars.githubusercontent.com/u/140311409', '01012312312'),
       ('danbeeS2', '1234', 'danbeeS2', 'F', '2000', 'https://avatars.githubusercontent.com/u/120550679', '01012312314'),
       ('cheesecat47', '1234', 'refo', 'M', '2000', 'https://avatars.githubusercontent.com/u/41780495', '01012312315'),
       ('Agwii', '1234', 'Agwii', 'M', '2000', 'https://avatars.githubusercontent.com/u/139833245', '01012312316'),
       ('minnnnnk0', '1234', 'minnnnnk', 'F', '2000', 'https://avatars.githubusercontent.com/u/139419164', '01012312317'),
       ('choihojo', '1234', 'choihojo', 'M', '2000', 'https://avatars.githubusercontent.com/u/87483951?', '01012312318'),
...
VALUES (@user_hoing97s, 'MANAGER'),
       (@user_danbeeS2, 'USER'),
       (@user_cheesecat47, 'USER'),
       (@user_Agwii, 'USER'),
       (@user_minnnnnk0, 'USER'),
       (@user_choihojo, 'USER'),
...
VALUES (@user_manager, '캠프유캠푸 캠핑장', '민간', '01012312312', '이국적인 캐러밴과 알찬 부대시설', '강원도 춘천시 남면에 자리했다. 서울양양고속도로 강촌IC에서 엘리시안강촌 방면으로 30분가량 달리면 도착한다. 이곳은 북한강 변의 수려한 풍광을 배경으로 캐러밴 40대가 들어찼다. 고급스러움이 돋보이는 유럽피안 캐러밴과 에어스트림 캐러밴이다. 모든 캐러밴은 각기 다른 주제로 꾸몄다. 이 덕분에 욕실에 중점을 둔 객실이나 침실에 초점을 맞춘 객실 등 취향에 따라 선택하는 재미가 있다. 외부에는 어닝 아래 테이블, 의자, 노천욕탕, 바비큐 시설을 마련했다. 캠핑장의 강점 중 하나는 부대시설이다. 카페, 수영장, 찜질방, 스파, 중앙 무대, 분수, 노래방 등 고급스러움으로 치장한 시설이 차고 넘친다.', 6600, '169-52-00647', '2017-6', '강원도', '춘천시', '강원도 춘천시 남면 가옹개길 52-9', null, '카라반', 'https://gocamping.or.kr/upload/camp/10/thumb/thumb_720_1869epdMHtUyrinZWKFHDWty.jpg', null, null, 10, '불가능', 10),
       ...
       (@user_hoing97s, '림스 글램핑', '민간', '033263330', '강진 림스정원 내에 위치한 글램핑, 야영장입니다.', '예쁜 정원과 함께하는 글램핑 정원과 함께 힐링할 수 있는 림스 글램핑은 전라남도에서 주최한 예쁜 정원 콘테스트에서 최우수상을 수상한 림스가든 안에 자리하고 있어 동화 속 같은 아름다운 정원에서 감성 글램핑을 즐길 수 있다. 아늑한 글램핑 내부 인테리어와 아이들이 신나게 물놀이할 수 있는 수영장과 트램펄린, 산책 코스까지 완벽한 편의 시설을 자랑한다. 또한 모든 객실은 세스코 관리를 받고 있어 더욱 믿을만하다. 반려견, 숯, 장작 등 개인 화기 및 반려견 동반은 불가하며 근처에 월출산과 가우도는 함께 둘러보기 좋은 관광 명소이다.', 6600, '853-60-00338', '2021-1', '전라남도', '강진군', '전남 강진군 강진읍 해강로 1038-30', NULL, '일반야영장,카라반,글램핑', 'https://gocamping.or.kr/upload/camp/100008/thumb/thumb_720_6107z9OQLZWk9dvIhx8OblHM.jpg', null, 'http://limsglamping.modoo.at', 0, '불가능', 2);
