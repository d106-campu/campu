...
const LoginPage = (): JSX.Element => {
  ...
  const [showSuccessModal, setCertificationSuccessModal] =
    useState<boolean>(false); // 인증 성공 모달
  ...
  return (
    <>
      ...
      >
          ...
          <div className="min-w-[300px] h-[50vh] flex-grow flex justify-around px-16 items-center">
            ...
            <div
              className={`flex flex-col items-center justify-center text-lg transition-transform duration-100 ${
                zIndexChangeDelay || isSignUpActive
                  ? "z-0 translate-x-0"
                  : `z-10 translate-x-28 sm:-translate-x-20 md:-translate-x-12 lg:translate-x-0 ${
                      isSmallScreen ? "opacity-0" : "opacity-100"
                    }`
              }`}
            >
            ...
            <div
              className={`flex flex-col items-center justify-center text-lg transition-transform ${
                zIndexChangeDelay || !isSignUpActive
                  ? "z-0 translate-x-0"
                  : `z-10 sm:translate-x-20 md:translate-x-16 lg:translate-x-0 ${
                      isSmallScreen ? "opacity-0" : "opacity-100"
                    }`
              }`}
            >
        ...
        >
          <div className="min-w-[460px] flex items-center justify-center">
