...
interface IChangePhoneSuccessModalProps {
  isOpen: boolean;
  onClose: () => void;
}

export const ChangePhoneSuccessModal = ({
  isOpen, onClose
}: IChangePhoneSuccessModalProps): JSX.Element => {
  ...
  return (
    ...
    >
      <div className="p-5 flex flex-col items-center justify-center">
        ...
        <p className="text-center pb-1">휴대폰 번호 변경이 완료되었습니다 !</p>
