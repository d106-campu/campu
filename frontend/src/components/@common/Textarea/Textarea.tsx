...
const Textarea = ({
  ...
  return (
    <div className="pb-5">
      ...
      <div
        className={`${width} ${
          borderType === "all" ? "border-2 rounded-lg" : "border-none"
        } border-[#E8E8E8] focus-within:border-[#A7A7A7] overflow-hidden`}
      ...
      <div className="flex justify-between items-center mt-2">
        ...
        <div className="text-sm text-right text-[#a7a7a7]">{`${value.length}${
          maxLength ? ` / ${maxLength}` : ""
        }자`}</div>
      </div>
    </div>
